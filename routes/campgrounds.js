...
router.post('/', validateCampground, catchAsync(async (req, res, next) => {
    ...
    req.flash('success', 'Succesfully added a new campground')      // Message showing when a campground is added
...
router.put('/:id', validateCampground, catchAsync(async (req, res) => {
    ...
    req.flash('success', 'Successfully updated campground!');        // Message showing when a campground is updated
